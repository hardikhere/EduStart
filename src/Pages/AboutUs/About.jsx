  ...
  return (
    <Base>
      <div className="about-title-container">
        <h2 className=""> About EduStart</h2>
      </div>
      <Container className="d-flex justify-content-center flex-wrap bg-light">
        <h5 className="m-5">
          This webapp is originally created by me( Hardik Khanchandani) but
          FredMat has owned its code. so branding name is changed just for
          damonstration purpose
        </h5>
              ...
              <Row>
                ...
                <Col md={10}>
                  ...
                  <div className="aboutcard-content red">
                    EduStart is envisioned to provide benefits of technology to
                    small & medium sized schools at lowest cost so that quality
              ...
              <Row>
                ...
                <Col md={10}>
                  ...
                  <div className="aboutcard-content green">
                    EduStart is a “Free education management tool” for schools
                    to build online presence and get competitive advantage at
                    least cost.
                  </div>
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col md={10}>
                  ...
                  <div className="aboutcard-content blue">
                    EduStart team is founded, operated and managed by team of
                    professional working for value creation in educational
                    sector.
                  </div>
                </Col>
              </Row>
