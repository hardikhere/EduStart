...
const Registration = (props) => {
    ...
    const handleSubmit = () => {
        axiosSchoolAdminInstance.post(APIS._createSchool, {
    ...
    const handleUpdate = () => {
        if (!props.sid) return;
        axiosSchoolAdminInstance.post(APIS._updateSchool(props.sid), {
        ...
        return (
            <div>
                ...
                <Row>
                    ...
                    <Col className="d-flex justify-content-center">
                        <Button className="" onClick={props.update ? handleUpdate : handleSubmit}>
    ...
    const getFormByStep = () => {
        switch (step) {
            case 0: return <Step1Form setStep={(s) => setstep(s)} step={step} />
            case 1: return <Step2Form setStep={(s) => setstep(s)} step={step} />
            case 2: return <Step3Form setStep={(s) => setstep(s)} step={step} />
            case 3: return <InfraForm setStep={(s) => setstep(s)} step={step} />
            case 4: return <PillarsForm setStep={(s) => setstep(s)} step={step} />
            case 5: return <Step5Form setStep={(s) => setstep(s)} step={step} />
