        ...
        <Form>
            ...
            <Form.Group>
                <Row>
                    ...
                    <Col>
                        <Form.Control as="select" onChange={handleChange("medium")}
            ...
            <Form.Group>
                ...
                <Adder array={schoolRegister.otherInfo?.activities || []} appender={
                    (item) => {
                ...
                <Row>
                    <Col>
                        <div class="form-check">
                            <input className="form-check-input" type="radio" name="playground"
                                id="playgroundyes"
            ...
            <Form.Group>
                ...
                <Adder array={schoolRegister.otherInfo?.outdoorSports || []} appender={
                    (item) => {
                        schoolRegister.otherInfo.outdoorSports =
                            [item, ...schoolRegister.otherInfo?.outdoorSports || []];
                        dispatch(_updateSchoolRegForm(schoolRegister));
                    }
                } deleter={
                    (item) => {
            ...
            <Form.Group>
                ...
                <Adder array={schoolRegister.otherInfo?.indoorSports || []} appender={
                    (item) => {
                        schoolRegister.otherInfo.indoorSports =
                            [item, ...schoolRegister.otherInfo?.indoorSports || []];
                        dispatch(_updateSchoolRegForm(schoolRegister));
                    }
                } deleter={
                    (item) => {
