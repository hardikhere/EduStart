...
import { faChartBar, faListAlt, faEdit, faQuestionCircle, faSearch, faChartLine, faChartPie, faCog } from "@fortawesome/free-solid-svg-icons";
...
const SideBar = () => {
  ...
  return (
    <ul className="ev-sidebar navbar-nav bg-gradient-primary mysidebar  accordion" id="accordionSidebar">
      {/* Sidebar - Brand */}
      <div className="nav-brand-area
      flex-column
       d-flex align-items-center justify-content-center" >
        <div className="sidebar-brand-text mx-3">FredMat</div>
      ...
      >
        ...
        <Nav.Item className={`sidebar-item flex 
          ${(ActiveView === "general" ||
            typeof ActiveView === "undefined") ? "sidebar-item-active" : ""} `}
        ...
        >
          ...
          <Nav.Link className={`sidebar-item-name `}>
            <Link style={{ color:"whitesmoke" }} to="/school-admin/dashboard?view=general">
              General Details
            </Link>
          </Nav.Link>
        </Nav.Item>
        ...
        >
          ...
          <Nav.Link className={`sidebar-item-name `}>
            <Link style={{ color:"whitesmoke" }} to="/school-admin/dashboard?view=inquiries">Inquiries</Link>
          </Nav.Link>
        </Nav.Item>
        ...
        >
          ...
          <Nav.Link className={`sidebar-item-name `}>
            <Link style={{ color:"whitesmoke" }} to="/school-admin/dashboard?view=settings">
              Settings
            </Link>
          </Nav.Link>
        </Nav.Item>

        <Nav.Item to="/school-admin/dashboard?view=feeds"
        ...
        >
          ...
          <Nav.Link className={`sidebar-item-name `}>
            <Link style={{ color:"whitesmoke" }} to="/school-admin/dashboard?view=feeds">
              Feeds
            </Link>
          </Nav.Link>
        </Nav.Item>
      ...
      <div className="flex flex-col sidebar-footer">
        <div className="flex flex-jc-center" style={{ color: "white" }}>Expiration Date</div>
