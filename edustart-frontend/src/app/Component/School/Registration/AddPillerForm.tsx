...
const AddPillerForm = (props) => {
    ...
    return (
        <div className="mb-5">
            <FormGroup>
                <FormLabel>Pillar {props.number} Title <sup className="text-danger">*</sup></FormLabel>
                <FormControl
                    value={props.title}
                    style={{ width: "50%" }} type="text" name="title" onChange={props.handleChange} />
            </FormGroup>
            <FormGroup>
                <FormLabel>Description <sup className="text-danger">*</sup></FormLabel>
                <FormControl
                    value={props.description}
                    as="textarea" type="text" name="description" onChange={props.handleChange} />
            </FormGroup>
            {props.number > 1 && <Button className="btn-danger" onClick={handleRemove}>Remove</Button>}
        </div>
    )
}
