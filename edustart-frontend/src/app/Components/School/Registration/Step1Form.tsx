...
const Step1Form = (props) => {
    ...
    const { hasAnyErrorForm1, yoeErr,
        emailErr, schoolNameErr, phoneErr,
        pinCodeErr, addressErr } = useFormValidation();
    ...
    return (
        <Form >
            ...
            <Form.Group controlId="formBasicEmail">
                ...
                />
                {emailErr && showErrors && <Form.Text className="text-danger">
                    Email must be valid
                </Form.Text>}
            </Form.Group>

            <Form.Group>
                <Form.Label>School Name <sup>*</sup></Form.Label>
                <Form.Control type="name" placeholder="Enter School Name"
                    onChange={handleChange("schoolName")}
                    value={schoolRegister.schoolName}
                />
                {
                    schoolNameErr && showErrors && <Form.Text className="text-danger">
            ...
            <Form.Group>
                <Row>
                    <Col>
                        <Form.Label>Select Board <sup>*</sup></Form.Label>

                    </Col>
                    <Col>
                        <Form.Control as="select" onChange={handleChange("board")}
            ...
            <Form.Group>
                <Row>
                    <Col>
                        <Form.Label>Select Classification <sup>*</sup></Form.Label>
                    </Col>
                    <Col>
                        <Form.Control as="select" onChange={handleChange("classification")}
                            aria-label="Default select example"
                            value={schoolRegister.classification}>
                            <option value="COED" selected>COED</option>
            ...
            <Form.Group>
                <Row>
                    <Col>
                        <Form.Label>Year Of Establishment <sup>*</sup></Form.Label>
                    </Col>
                    <Col>
                        <Form.Control type="text" placeholder="2012"
                            onChange={handleChange("yearOfEstablishment")}
                            value={schoolRegister.yearOfEstablishment} />
                        {
                            yoeErr && showErrors && <Form.Text className="text-danger">
            ...
            <Form.Group>
                <Row>
                    ...
                    <Col>
                        <Form.Control required type="text" placeholder="+91XXXXXXXXXX"
                            onChange={handleChange("phoneNumber")}
                            value={schoolRegister.phoneNumber} />
                        {
                            phoneErr && showErrors && <Form.Text className="text-danger">
            ...
            <Form.Group>
                <Row>
                    <Col>
                        <Form.Label>Area Pin Code <sup>*</sup></Form.Label>
                    </Col>
                    <Col>
                        ...
                        {
                            pinCodeErr && showErrors && <Form.Text className="text-danger">
            ...
            <Form.Group controlId="formBasicEmail">
                ...
                <textarea className="form-control" type=""
                    onChange={handleChange("address")}
                    value={schoolRegister.address}
                    placeholder="Enter Full Address" />
                {
                    addressErr && showErrors && <Form.Text className="text-danger">
