...
//     setloading(true);
//     axiosInstance
//       .post(APIS._schoolAdminLogin, UserRes)
//       .then((res) => {
//         console.log(res.data);
//         dispatch(_updateSchoolAdminInfo(res.data?.data?.user));
//         setloading(false);
//         localStorage.setItem("afmt", res.data?.data?.token);
//         if (!res.data.data.user.schoolId) setshouldRedirect("/school/register");
...
//               <div>
//                 <h6 style={{ textAlign: "right", color: "#ffffffcc" }}>
//                   New to EduStart?
//                 </h6>
...
const SchoolAdminLogin = () => {
  return <div>SchoolAdminLogin</div>;
};
