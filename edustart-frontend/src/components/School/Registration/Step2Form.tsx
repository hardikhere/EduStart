...
const Step2Form = (props) => {
  ...
  const handleChange = (name, value) => (event) => {
    if (value === undefined) schoolRegister[name] = event.target.value;
    else schoolRegister[name] = value;
    dispatch(_updateSchoolRegForm(schoolRegister));
  };
      ...
      <Form.Group>
        <Row>
          ...
          <Col>
            <Form.Control
              as="select"
              onChange={handleChangeOther("gradeFrom")}
              aria-label="Default select example"
            >
              <option selected value="nur">
                Nur
              </option>
      ...
      <Form.Group>
        <Row>
          ...
          <Col>
            <Form.Control
              as="select"
              onChange={handleChangeOther("gradeTo")}
              aria-label="Default select example"
            >
      ...
      <Form.Group>
        <Row>
          ...
          <Col>
            <Form.Control
              as="select"
              onChange={handleChange("entryAge")}
              aria-label="Default select example"
            >
